...
import com.fittracker.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() , HBRecorderListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityCameraBinding.btnRecord.bringToFront()
        activityCameraBinding.btnRecord.setOnClickListener {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (requestCode == Constants.SCREEN_RECORD_REQUEST_CODE) {
                if (resultCode == RESULT_OK) {
                    ...
                    //Start screen recording
                    hbRecorder.startScreenRecording(data, resultCode)
                    FormFixSharedPreferences.saveSharedPreferencesValue(this@CameraActivity,Constants.PREF_KEY_VIDEO_RECORDER_PERMISSION,true)
                }
            }
        }
