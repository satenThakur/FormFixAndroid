...
class ImageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getStringExtra(Constants.MESSAGE_TYPE).equals(getString(string.knee_crossing_toes))) {

            activityImageBinding.imageHolder.setImageResource(R.drawable.img_knees_crossing_toes)

        } else if (intent.getStringExtra(Constants.MESSAGE_TYPE).equals(getString(string.tuck_hips))) {

            activityImageBinding.imageHolder.setImageResource(R.drawable.img_hip_correction_img)

        } else if (intent.getStringExtra(Constants.MESSAGE_TYPE).equals(getString(string.externally_rotate_feet))) {

            activityImageBinding.imageHolder.setImageResource(R.drawable.img_rotate_feet_externally)

        } else if (intent.getStringExtra(Constants.MESSAGE_TYPE).equals(getString(string.knees_going_inwards))) {
