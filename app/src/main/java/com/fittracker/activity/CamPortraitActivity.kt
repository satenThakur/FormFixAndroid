...
class CamPortraitActivity : AppCompatActivity() , HBRecorderListener {
    private lateinit var activityCamPortraitBinding: ActivityCamPortraitBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityCamPortraitBinding.btnRecord.bringToFront()
        activityCamPortraitBinding.btnRecord.setOnClickListener {
            if (ContextCompat.checkSelfPermission(this@CamPortraitActivity, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED){
                hasPermissions=true;
            }
            if (hasPermissions) {
                if (hbRecorder.isBusyRecording) {
                    hbRecorder.stopScreenRecording()
                    activityCamPortraitBinding.btnRecord.setImageDrawable(resources.getDrawable(R.drawable.iv_start_record))
